...
* {
        ...
        .wrapper.fullscreen-mode .main {
            width: 100%;
        }

        .wrapper.fullscreen-mode .scanner-card {
            width: 420px;
        }

        .wrapper.fullscreen-mode .asset-card {
            flex: 1;
        }

        .wrapper.fullscreen-mode .empty-state {
            height: 90%;
        }
...
<div class="wrapper">
        ...
        <div class="main">
            ...
            <div class="scanner-card">
                ...
                <div class="scanner-text">
                    Search for property information by
                ...
                <div class="input-group">
                    ...
                    <button class="scan-btn" onclick="scanAsset()">
                        Search Property
                    </button>
                ...
                <!-- Quick Tips -->
                <div class="quick-tips-container"></div>
            </div>
            <div class="recent-searches-container"></div>
            <div class="quick-tips-container"></div>
            ...
            <div class="asset-card">
                ...
                <div id="emptyState" class="empty-state">
                    ...
                    <h2>
                        No Property Information displayed
                    </h2>

                    <p>
                        Scan or Search a property to view<br>
                        its information and details.
                    </p>
                ...
                <div id="assetInfo" class="asset-info">
                    ...
                    <div class="property-top">
                        ...
                        <img src="{{ asset('images/imges.jpg') }}" class="property-image">

                        <div class="property-details">

                            <span class="status-badge">Active</span>

                            <h1>Executive Office Chair</h1>

                            <div class="tracking-number">
                                Tracking No. <br>
                                <span>TRK-2026-000123</span>
                            </div>

                            <p class="description-text">
                                High quality ergonomic office chair with
                                adjustable features for maximum comfort
                                and back support.
                            </p>
                    ...
                    <div class="property-grid">
                        ...
                        <div class="property-box">
                            ...
                            <h3>Building A Room 202</h3>
                        </div>

                        <div class="property-box">
                            <i class="fa-regular fa-user"></i>
                            <label>Assignee</label>
                            <h3>Adrian Lamoste</h3>
                        </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector(".recent-searches-container").innerHTML = `
    ...
    `;
            ...
            document.querySelector(".quick-tips-container").innerHTML = `
        ...
        <div class="tip-card">
            ...
            <div class="tip-content">
                <h4>Avoid Glare</h4>
                <p>Avoid reflections and direct sunlight.</p>
            </div>
        </div>
        ...
        <div class="tip-card">
            ...
            <div class="tip-content">
                <h4>Keep Steady</h4>
                <p>Hold the scanner steady while scanning.</p>
            </div>
        </div>
    `;
        });
